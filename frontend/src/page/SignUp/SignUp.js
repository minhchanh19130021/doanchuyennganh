    ...
    <div className="container">
        <div className="row py-3 mt-4 align-items-center">
          ...
          <div className="col-md-5 pr-lg-8 mb-8 mb-md-12">
            <img src="https://myaloha.vn/pages/mainpage/img/img_product_4.png" alt="" className="img-fluid mb-3 d-none d-md-block" />
          </div>
          
          {/* Registeration Form */}
          <div className="col-md-5 col-lg-6 ml-auto mb-6 ">
            <h2 className="text-center h2">Đăng ký thành viên</h2>
            ...
            <ToastContainer
              ...
              <div className="row">
                ...
                {/* Username*/}
                <div className="input-group col-lg-10 mt-4" style={InputGroup}>
                  <span className="input-group-text bg-white py-3 px-3 border-md "  style={formIcon}>
                    <FontAwesomeIcon icon="fa-solid fa-user" />
                    </span>
                  <input id="username" type="text" name="username" onChange={formik.handleChange} value={formik.values.username} placeholder="Họ và tên" style={formInput} className="form-control bg-white border-left-0 border-md" />
                </div>
                ...
                <div className="input-group col-lg-10 mt-4" style={InputGroup}>
                  ...
                  <input id="email" type="text" name="email" onChange={formik.handleChange} value={formik.values.email} placeholder="Email" style={formInput} className="form-control bg-white border-left-0 border-md" />
                </div>
                {formik.errors.email && formik.touched.email && (<p style={p}>{formik.errors.email}</p>)}

                {/* Password */}
                <div className="input-group col-lg-6 mb-8 m-0 mt-4" style={InputGroup}>
                    <span className="input-group-text bg-white py-3 px-3 border-md " style={formIcon}>
                      <FontAwesomeIcon icon={faLock}/>
                    </span>
                  <input id="password" type="password" name="password" onChange={formik.handleChange} value={formik.values.password} style={formInput} placeholder="Mật khẩu" className="form-control bg-white border-left- border-md" />
                </div>
                ...
                <div className="text-center w-100">
                  <p className="text-muted font-weight-bold">Đã đăng ký? <a href="#" className="text-primary ml-2 "> <NavLink to="/signin">Đăng Nhập</NavLink></a></p>
                </div>
              </div>
            </form>
          </div>
