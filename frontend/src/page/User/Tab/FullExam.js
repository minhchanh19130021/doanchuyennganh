                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            {e?.answers
                                                                ?.sort((a, b) => a.id - b.id)
                                                                ?.map((s) => (
                                                                    <td className="px-6 py-4" key={s.id}>
                                                                        <p>{s?.content}</p>
                                                                    </td>
                                                                ))}
                ...
                <tbody>
                    {examList?.map((e, index) => (
                        <tr className="border-b bg-gray-50 dark:border-gray-700 dark:bg-gray-800" key={index}>
                            ...
                            <td className="px-6 py-4">{e?.questionnaires.length}</td>
                            <td className="px-6 py-4">{e?.auditInfo?.createDate.slice(0, 10)}</td>
                            <td className="px-6 py-4">
                                <button
                                    type="button"
                                    ...
                                    onClick={async () => {
                                        ...
                                        await questionService.findQuestionByExamId(e?.id).then((res) => {
